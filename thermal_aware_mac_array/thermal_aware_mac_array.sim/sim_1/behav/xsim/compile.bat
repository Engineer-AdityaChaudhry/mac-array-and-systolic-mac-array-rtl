...
REM
REM Generated by Vivado on Mon Apr 06 22:41:04 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_systolic_mac_array_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_systolic_mac_array_vlog.prj -log xvlog.log
